...
void updateAstarGhost(int ghostIndex)
{
    ...
    if (as.search(s, e, m)) {
          ...
          //  {
                ...
                //}
                             ...
                             //       ghost[ghostIndex][0] = (col + 0.5f) * squareSize;
                              ...
                              //  ghost[ghostIndex][0] += GHOST_SPEED/2;
                              //  ghost[ghostIndex][0] += GHOST_SPEED/2;
                moveOrangeGhost(newDir, ghostIndex);
            ...
            //move left
               ...
               //  if (row != ghostDecisionLoc[ghostIndex][0] || col != ghostDecisionLoc[ghostIndex][1]) {
                ...
                //     in any case, we remember that this ghost has made a direction decision for this square
            //    ghostDecisionLoc[ghostIndex][0] = row;    //row
            //    ghostDecisionLoc[ghostIndex][1] = col; //col
          //  }
          //  else
          //  {
          //      newDir = ghostDir[ghostIndex];
        ...
        //    if (newDir != ghostDir[ghostIndex]) {
         ...
         //   ghost[ghostIndex][1] -= GHOST_SPEED/2;
           // ghost[ghostIndex][1] -= GHOST_SPEED/2;
                moveOrangeGhost(newDir, ghostIndex);
...
void moveOrangeGhost(MoveDir newDir, int ghostIndex) {
